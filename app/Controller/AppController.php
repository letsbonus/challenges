...
class AppController extends Controller {
    ...
    public function beforeFilter() {
        ...
        if (($this->request->controller == 'pages') || (($this->Auth->login()) && $this->request->controller == 'acl')) {
          $this->Auth->allow();
        } else {
        ...
        if (($this->request->controller == 'Users') && ($this->request->action == 'initDB')) {
            $this->Auth->allow();
        }
        
//        $this->Auth->allow();  si queremos cambiar permisos acl
    }
}